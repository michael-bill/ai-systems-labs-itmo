...
def pr_args(results):
    ...
    Возвращает:
        precisions: список значений Precision. Все ответы которые он выбрал положительными и они на самом деле положительны / все ответы которые он выбрал положительными
        recalls: список значений Recall. Все ответы которые он выбрал положительными и они на самом деле положительны / все ответы которые он выбрал положительными
    '''
    precisions = []
    recalls = []
